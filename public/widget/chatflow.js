(function() {
  ...
  var config = window.ChatFlowConfig || {};
  var widgetKey = config.widgetKey;

  if (!widgetKey) {
    console.error('ChatFlow: Widget key is required');
    return;
  }

  // Create widget container
  var container = document.createElement('div');
  container.id = 'chatflow-widget-container';
