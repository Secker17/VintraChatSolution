...
<script>
  ...
  const npmCode = `npm install @chatflow/react

// In your React app
import { ChatFlowWidget } from '@chatflow/react'

function App() {
  return (
    <ChatFlowWidget widgetKey="${widgetKey}" />
  )
}`
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Add the ChatFlow widget to your website in minutes
        </p>
      </div>
        ...
        <CardContent>
          <Tabs defaultValue="script" className="w-full">
            ...
            <TabsContent value="npm" className="mt-4 space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Install and use the ChatFlow React component:
              </p>
              <div className="relative">
                <pre className="rounded-lg bg-muted p-4 overflow-x-auto text-sm">
                  <code>{npmCode}</code>
      ...
      <Card>
        ...
        <CardContent>
          <Button asChild>
            <a href={`/widget/preview/${widgetKey}`} target="_blank">
              Open Widget Preview
            </a>
          </Button>
        </CardContent>
